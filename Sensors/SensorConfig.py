...
WALKER_BOTTOM_BOUNDARY = int(0.5 * SCAN_UNIT * 1.5) # 0.5m x 1.5, considering the backward area
WALKER_LEFT_BOUNDARY = int(0.354 * SCAN_UNIT)  # 0.354m
WALKER_RIGHT_BOUNDARY = int(0.354 * SCAN_UNIT)  # 0.354m
WALKER_BOX_BOUNDARY_VERTICAL = int(0.09 * SCAN_UNIT) # approximately the wheel diameter
# for Hong Kong Walker
# WALKER_REAR_WHEEL_ROW_IDX = int(0.48 * SCAN_UNIT)
# WALKER_REAR_WHEEL_COL_IDX = int(0.09 * SCAN_UNIT)
# for Shenzhen Walker
WALKER_REAR_WHEEL_ROW_IDX = int(0.38 * SCAN_UNIT)
WALKER_REAR_WHEEL_COL_IDX = int(0.10 * SCAN_UNIT)
WALKER_REAR_WHEEL_RADIUS = int(0.04 * SCAN_UNIT)
WALKER_REAR_WHEEL_WIDTH = int(0.03 * SCAN_UNIT)
...
# obstacle part
OBSTACLE_DISTANCE = int(0.05 * SCAN_UNIT)  # 50 mm detection